class bus_config;
    ...
    // Cantidad de transacciones generadas por cada terminal
    ...
    protected function new();
        ...
        // prueba general con tráfico válido
    ...
    function void validate();
        ...
        if (min_delay > max_delay) begin
            $fatal(
                1,
                "CONFIG ERROR: min_delay (%0d) > max_delay (%0d)",
                min_delay,
                max_delay
            );
        end
        ...
        if ((wt_valid + wt_broadcast + wt_invalid) == 0) begin
            $fatal(
                1,
                "CONFIG ERROR: todos los pesos de destino son 0"
            );
        end
    ...
    function void print();
        ...
        $display(
            "Peso destino invalido  : %0d",
            wt_invalid
        );

        $display(
            "Self-send permitido    : %0d",
            allow_self_send
        );
